...
class award_criteria_profile extends award_criteria {
    ...
    /* @var int Criteria [BADGE_CRITERIA_TYPE_CUSTOM] */
    public $criteriatype = BADGE_CRITERIA_TYPE_CUSTOM;
    ...
    public function get_options(&$mform) {
		...
		$mform->addElement('title', 'not used', 'not used!' );
    ...
    public function review($userid) {
        ...
        // $courseid = $DB->get_field('badge', 'courseid', array('id' => $this->badgeid));
		 $awarded = false;
		// $lvls = $DB->get_field('class_metric_table', 'levels', array('courseid' => $courseid)  );
		// echo $lvls;
